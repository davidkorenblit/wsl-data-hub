  ...
  <article class="rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-[#121215] p-6 sm:p-8 space-y-8 shadow-sm">
    ...
    <div class="prose dark:prose-invert max-w-none text-neutral-800 dark:text-neutral-200 leading-relaxed space-y-8 font-sans text-base sm:text-lg">
      ...
      <section class="space-y-4">
        <h2 class="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-white flex items-center gap-2">
          <span>⚡</span>
          <span>הערה על העמדה של קריסטי הנסן: תמיד טובה בשמאל, בימין קצת פחות</span>
        </h2>

        <p>
          במהלך השנים ראינו מאמנים שמנסים לנייד את קריסטי הנסן לאורך כל חזית ההתקפה — באגף ימין, כחלוצה קדמית, ובאגף שמאל. הדאטה לאורך הקריירה מראה תבנית עקבית וברורה: <strong>הנסן היא שחקנית שחייבת לפעול מצד שמאל</strong>.
        </p>

        <p>
          בעונת 2022/23 בווילה היא הייתה <strong>מלכת הבישולים של ה-WSL</strong> (9 בישולי ליגה, 10 בכל המסגרות) כששיחקה באגף שמאל, עם מהירות על הקו וכדורי רוחב חדים לרייצ'ל דיילי. לעומת זאת, כשהיא משובצת באגף ימין, היכולת שלה לייצר איומים נפגעת משמעותית — היא מתקשה לחתוך על הרגל הפחות דומיננטית שלה ונסגרת בקלות יחסית.
        </p>

        <p>
          רוברט וילהאם בספרס הבין את זה במדויק: הנסן פותחת משמאל, אך נכנסת לרחבה כ-<em>Inside Forward</em> (כך כבשה צמד מול ווסטהאם במחזור 1). משמאל יש לה גם את המרחב להגביה וגם את זווית הבעיטה הנקייה לפינה הרחוקה.
        </p>
      </section>

...
<div class="space-y-6 text-neutral-800 dark:text-neutral-200 leading-relaxed text-base sm:text-lg font-sans">
  ...
  <article class="space-y-3 pt-4" id="section-combo2">
    ...
    <p>
      <strong>המבנה הטקטי וההבדל המרכזי:</strong> כאן, בניגוד לקומבינציה 1, <strong>אמילי פוקס אינה עולה בהרפתקנות קדימה אלא נשארת ממושמעת ועמוקה בעמדת המגן הימני</strong> כדי לנעול את האגף. השטח שנפתח במרכז מנוצל על ידי ג'ורג'יה סטאנוויי שתוקפת שטחים פנויים מקו שני ומאיימת מרחוק. רוסו משחקת בעמדת ה-10, מושכת את הבלמיות של היריבה ומפנה מסדרונות לסטינה בעומק, בעוד מריונה ואוליביה סמית' מבודדות באגפים באחד-על-אחד.
    </p>
    ...
    <div class="p-3.5 rounded bg-slate-900/60 border border-slate-800 text-xs font-sans text-slate-300 space-y-1.5">
      ...
      <ul class="list-disc list-inside space-y-1 text-slate-300">
        ...
        <li><strong>שליטה בקצב:</strong> קים ליטל עם 88.4% דיוק מסירה מאזנת את האגרסיביות של סטאנוויי.</li>
      </ul>
    </div>
  </article>
  ...
  <article class="space-y-3 pt-4" id="section-combo3">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-neutral-200 dark:border-neutral-800 pb-2">
      <div class="flex items-center gap-2">
        ...
        <h2 class="text-lg sm:text-xl font-bold text-neutral-900 dark:text-white">
          3. קומבינציה ג': מול אריות אירופה, לחץ קומפקטי ומעברים מהירים (4-3-3)
        </h2>
      </div>
    ...
    <p>
      <strong>התרחיש:</strong> מפגשים בליגת האלופות (מול ברצלונה או ליון) שבהם לארסנל אין שליטה בלעדית בכדור והיא נדרשת להגן קומפקטי, לחסום את המרכז ולעקוץ בהתקפות מעבר מהירות.
    </p>

    <p>
      <strong>המבנה הטקטי:</strong> עמוד שדרה קטלני של <strong>קים ליטל, ג'ורג'יה סטאנוויי ומריונה קלדנטיי</strong> במרכז המגרש. סטאנוויי וליטל מחלצות כדורים וחונקות את המרכז, ומריונה משתחררת מלחץ ומשגרת מיד כדורי עומק למעבר. בהתקפה, המהירות המסחררת של <strong>ליסה באום</strong> (רכש צעיר ונפיץ מהמבורג) בימין ושל אוליביה סמית' / קלואי קלי בשמאל קורעת את הגנת היריבה באחד-על-אחד, כשרוסו מהווה עוגן פיזי בחוד.
    </p>
    ...
    <div class="p-3.5 rounded bg-slate-900/60 border border-slate-800 text-xs font-sans text-slate-300 space-y-1.5">
      ...
      <ul class="list-disc list-inside space-y-1 text-slate-300">
        ...
        <li><strong>שחרור לחץ מובנה:</strong> השילוב בין דיוק המסירה של ליטל (88.4%) לחילוצים של סטאנוויי (אחוזון 94) מאפשר לארסנל להחזיק מעמד מול לחץ אירופי כבד.</li>
      </ul>
    </div>
  </article>
  ...
  <article class="space-y-3 pt-4" id="section-combo4">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-neutral-200 dark:border-neutral-800 pb-2">
      <div class="flex items-center gap-2">
        <span class="text-lg">🔥</span>
        <h2 class="text-lg sm:text-xl font-bold text-neutral-900 dark:text-white">
          4. קומבינציה ד': מקרה חירום – "חייבים גול בדקה ה-80" (3-2-1-2-2)
        </h2>
      </div>
    ...
    <p>
      <strong>התרחיש:</strong> פיגור או שוויון מאוחר כשהיריבה שוכבת על הדשא וצריך לייצר כאוס מוחלט, להציף את הרחבה ולהכריע משחק.
    </p>

    <p>
      <strong>המבנה הטקטי (כפי שהורכב על הלוח):</strong> מעבר למערך 3-2-1-2-2 קיצוני. שלישיית הגנה מאחור (היינדס, וובן-מוי, ויליאמסון), עם קים ליטל ואונה באטייה כפיבוט כפול במרכז שמחזיק בכדור ומחלק מסירות. סמית' משמאל ומריונה מימין מרווחות את המשחק עד קווי החוץ, אלסיה רוסו פועלת כ-10 מרכזית שמזינה את ההתקפה, וברחבה מוצב <strong>צמד חלוצות עוצמתי (סטינה בלקסטניוס ומישל אג'ימאן)</strong> שמרסקות את הבלמיות בכדורי גובה, נועלות בלמיות ומייצרות עומס בלתי אפשרי להגנה.
    </p>
  </article>
...
(function() {
  ...
  const FORMATIONS = {
    ...
    combo2: {
      ...
      desc: "<strong>טקטיקת מפתח:</strong> אמילי פוקס נשארת ממושמעת מאחור ולא עולה הרפתקני. סטאנוויי תוקפת שטחים פנויים מקו שני, רוסו ב-10 מזינה את סטינה וסמית'.",
      players: [
        { id: "vandomselaar", x: 50, y: 88, role: "GK" },
        ...
        { id: "stanway", x: 62, y: 56, role: "DM (קו שני)" },
    ...
    combo3: {
      ...
      desc: "<strong>טקטיקת מפתח:</strong> קים ליטל, סטאנוויי ומריונה בקישור חונקות את המרכז ומנהלות מעברים מהירים, ליסה באום וסמית' באגפים ורוסו בחוד.",
      players: [
        ...
        { id: "mariona", x: 32, y: 48, role: "CM (Transition)" },
        { id: "baum", x: 75, y: 26, role: "RW (Pace)" },
        { id: "smith", x: 25, y: 26, role: "LW" },
        { id: "russo", x: 50, y: 16, role: "ST" }
      ]
    },
    combo4: {
      name: "4. מקרה חירום – 'חייבים גול בדקה 80' (3-2-1-2-2)",
      desc: "<strong>טקטיקת מפתח:</strong> שלישיית הגנה (היינדס-וובן מוי-ויליאמסון), ליטל ובאטייה בפיבוט כפול, סמית' ומריונה ברוחב מקסימלי, רוסו ב-10 וצמד חלוצות עוצמתי (סטינה ואג'ימאן) ברחבה.",
      players: [
        { id: "vandomselaar", x: 50, y: 88, role: "GK" },
        { id: "williamson", x: 78, y: 76, role: "RCB" },
        { id: "wubbenmoy", x: 50, y: 76, role: "CB" },
        { id: "hinds", x: 22, y: 76, role: "LCB" },
        { id: "batlle", x: 64, y: 55, role: "DM" },
        { id: "little", x: 36, y: 55, role: "DM" },
        { id: "mariona", x: 86, y: 28, role: "RW" },
        { id: "russo", x: 50, y: 38, role: "AM (#10)" },
        { id: "smith", x: 14, y: 28, role: "LW" },
        { id: "blackstenius", x: 65, y: 12, role: "ST" },
        { id: "agyemang", x: 35, y: 12, role: "ST" }
      ]
    }
  };
